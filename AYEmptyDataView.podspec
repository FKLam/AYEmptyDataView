...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AYEmptyDataView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/amg/AYEmptyDataView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'amg' => 'lfk0120@163.com' }
  s.source           = { :git => 'https://github.com/amg/AYEmptyDataView.git', :tag => s.version.to_s }
