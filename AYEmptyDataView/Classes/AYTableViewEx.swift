...
extension UITableView {
    ...
    /**
     空数据显现数据代理对象
     */
    weak public var dzn_tv_emptyDataSource: AYEmptyDataSource?  {
        get {
            return objc_getAssociatedObject(self, &kEmptyDataSetSource_Tv) as? AYEmptyDataSource
        }
        set(newValue) {
    ...
    /**
     空数据显现代理对象
     */
    weak public var dzn_tv_emptyDelegate: AYEmptyDelegate? {
        
        get {
            return objc_getAssociatedObject(self, &kEmptyDelegate_Tv) as? AYEmptyDelegate
        }
        set(newValue) {
            if newValue != nil {
                dzn_Tv_invalidate()
...
extension UITableView {
    ...
    public var emptyView_Tv: AYEmptyDataView? {
        
        get {
            
            if let view = objc_getAssociatedObject(self, &kEmptyDataSetView_Tv) as? AYEmptyDataView {
                return view
            }
